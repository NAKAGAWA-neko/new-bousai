...
const typhoonNumLandChartConfig: ChartConfiguration<"bar" | "line", number[], string> = {
  type: "bar",
  data: {
    labels: [
      "1951",
...
// 局地的大雨、1時間の降水量50m-----------------------
const localHeavyR50ChartConfig: ChartConfiguration<"bar", number[], string> = {
  type: "bar",
  data: {
    labels: [
      "1976",
...
// 局地的大雨、1時間の降水量80m-----------------------
const localHeavyR80ChartConfig: ChartConfiguration<"bar", number[], string> = {
  type: "bar",
  data: {
    labels: [
      "1976",
...
// 局地的大雨、1時間の降水量100m-----------------------
const localHeavyR100ChartConfig: ChartConfiguration<"bar", number[], string> = {
  type: "bar",
  data: {
    labels: [
      "1976",
...
let typhoonNumLandChart: Chart | null = null;
let localHeavyR50Chart: Chart | null = null;
let localHeavyR80Chart: Chart | null = null;
let localHeavyR100Chart: Chart | null = null;
